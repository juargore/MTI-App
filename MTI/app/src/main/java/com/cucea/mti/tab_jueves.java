...
public class tab_jueves extends Fragment {
    ...
    ListView listView_Jueves;
    TextView txtCiclo_Jueves;

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.tab_jueves,container,false);

        listView_Jueves = (ListView)view.findViewById(R.id.listView_Jueves);
        txtCiclo_Jueves = (TextView)view.findViewById(R.id.txtCiclo_Jueves);

        ArrayList list = ((Variables) getActivity().getApplication()).getListJue();
        listView_Jueves.setAdapter(new ImageAdapter(getActivity(),list));
        listView_Jueves.setFastScrollEnabled(true);
        listView_Jueves.setVerticalScrollBarEnabled(false);
    ...
    public class ImageAdapter extends BaseAdapter
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            txtCiclo_Jueves.setText(""+ newsItem.get("inicio_ciclo")+" - "+newsItem.get("fin_ciclo"));
            holder.txtHora_Horario.setText(""+ newsItem.get("jueves_inicio")+" - "+newsItem.get("jueves_fin"));
